...
public class MachineDataManager implements RemoteUploadManager{
	...
	public Machine getLocalMachine(String columnName, String id) {
	...
	public void populateLocalDB(int numMachines) {
